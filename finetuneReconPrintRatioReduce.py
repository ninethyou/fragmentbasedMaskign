...
from dataset.dataset_test_reduceTrain import MolTestDatasetWrapper
...
if __name__ == "__main__":
    ...
    parser.add_argument('--reduceRatio', type=float, default=1, help = "Alpha for the loss function")
    ...
    columns = ['Time', 'Seed', 'mask_rate','result', 'reduceData']
    

    results_list.append([current_time, seed, args.mask_rate,  result, args.reduceRatio])
