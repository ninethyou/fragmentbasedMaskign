...
class FineTune(object):
    ...
    def _step(self, model_list, data, n_iter):
        ...
        if args.mask_edge:
            ...
            print(predicted_classes, mask_node_label[:, 0])
    ...
    def train(self):
        ...
        alpha = torch.exp(torch.tensor(args.alpha, dtype = torch.float))
        ...
        for epoch_counter in range(self.config['epochs']):
            for bn, data in enumerate(train_loader):
                ...
                pred, total_loss, loss_end, loss_recon, loss_recon_edge, acc = self._step(model_list, data, n_iter)
