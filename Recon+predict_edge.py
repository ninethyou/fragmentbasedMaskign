...
class FineTune(object):
    ...
    def _step_test(self, model_list, data, n_iter):
        ...
        if args.mask_edge:
            ...
            node_rep_masked, output2_masked = model(data, data.masked_atom_indices, data.connected_edge_indices)
        ...
        if args.mask_edge:
            total_loss = loss + args.alpha *  loss_recon_edge
            return total_loss, loss, (0, loss_recon_edge), pred_node, data.mask_node_label[:,0], pred_edge, mask_edge_label[:,0]
    ...
    def _step(self, model_list, data, n_iter):
        ...
        if args.mask_edge:
            ...
            return  total_loss, loss, 0, loss_recon_edge, (0, accuracy_edge)
