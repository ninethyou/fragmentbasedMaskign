...
def plot_class_frequencies(predicted_classes, label):
    ...
    plt.show()  # You can comment this out if you don't want to display the plo
...
if __name__ == "__main__":
    ...
    parser.add_argument('--alpha', type=float, default=0.1, help = "Alpha for the loss function")
