...
class FineTune(object):
    ...
    def train(self):
        ...
        if self.config['model_type'] == 'sage':
            from models.graphsage_finetuneRecon_rich import GraphSage_rich
            model = GraphSage_rich(self.config['dataset']['task'], **self.config["model"]).to(self.device)
