...
def main():
    ...
    if args.dataset == 'zinc_standard_agent':
        ...
        train_loader = DataLoaderMaskingPredTestRich(dataset, batch_size=args.batch_size, shuffle=True, drop_last = True, num_workers = args.num_workers,  mask_rate=args.mask_rate, mask_edge=args.mask_edge, pin_memory = True)
