...
class GINetReconEmbeddingBottom(nn.Module):
    """
    Args:
    ...
    def __init__(self, 
        ...
        super(GINetReconEmbeddingBottom, self).__init__()
    ...
    def forward(self, data, mask_node = None, mask_rate = None):
        x = data.x
        ...
        if mask_rate is not None:
            ...
            node = bottomk(score.squeeze(), ratio = mask_rate, batch = data.batch)
