...
class GCNConv(MessagePassing):
    def __init__(self, emb_dim, aggr="add"):
        ...
        self.edge_embedding3 = nn.Embedding(2, 1)
        self.edge_embedding4 = nn.Embedding(2, 1)
        self.edge_embedding5 = nn.Embedding(7, 1)
...
class GCN(nn.Module):
    def __init__(self, task='classification', num_layer=5, emb_dim=300, feat_dim=256, drop_ratio=0, pool='mean', pred_n_layer=2, num_task = 1):
