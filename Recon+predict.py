...
class FineTune(object):
    ...
    def train(self):
        ...
        model_list = [ model_recon, linear_pred_atoms, linear_pred_bonds]
        optimizer_list = [ optimzer_model_recon, optimizer_linear_pred_atoms, optimizer_linear_pred_bonds]
        ...
        for epoch_counter in range(self.config['epochs']):
            for bn, data in enumerate(train_loader):
                ...
                optimzer_model_recon.zero_grad()
