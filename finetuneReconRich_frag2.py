...
from dataset.dataset_test_rich2_fragment2 import MolTestDatasetWrapperRich
...
class FineTune(object):
    ...
    def _step(self, model_list, data, n_iter):
        ...
        masked_atom_indices = torch.tensor(masked_atom_indices, dtype=torch.long).to(self.device)
        ...
        if args.mask_edge:
            ...
            node_rep_masked2, output2_masked = model(masked_data)   
  
            pred_node = linear_pred_atoms(node_rep_masked2[masked_atom_indices])
