...
def main():
    ...
    if args.dataset == 'zinc_standard_agent':
        from dataset_pretrain_zinc_fragment import MoleculeDataset
        from util import MaskFragment
        from batch import BatchMasking        
        
        dataset = MoleculeDataset(data_path = "dataset - fragment/" + args.dataset, )
        
        transform = MaskFragment(num_atom_type = 119, num_edge_type = 5, mask_rate = args.mask_rate, mask_edge=args.mask_edge) 
        ...
        dataset = MoleculeDataset("dataset - fragment/" + args.dataset, dataset=args.dataset)
    ...
    output_file_temp = "./pretrain2/" + "/fragment/" + f"{args.dataset}_{args.gnn_type}_{args.mask_rate}_{args.seed}"        
    ...
    fn_base = f'{directory_name}/pretrain_fragment_{args.dataset}_{args.split}'
