...
class FineTune(object):
    def __init__(self, dataset, config):
        ...
        self.target_ema_updater = EMA(args.moving_average_decay)
    ...
    def _step_test(self, model_list, data, n_iter):
        # get the prediction

        model, model_recon, linear_pred_atoms, linear_pred_bonds = model_list
        ...
        node_rep_masked, output2_masked = model_recon(data_recon)
    ...
    def _step(self, model_list, data, n_iter):
        ...
        with torch.no_grad():
            node_repre2, output2_masked= model_recon(masked_x, data.masked_atom_indices)
            ...
            if args.mask_edge:
                ...
                node_rep_masked, output2_masked = model_recon(masked_x)
        ...
        loss_rep = sce_loss(node_repre2, node_rep)
        ...
        if args.mask_edge:
            ...
            total_loss = loss + args.alpha * loss_recon_node + loss_recon_edge + loss_rep
            ...
            total_loss = loss + args.alpha * loss_recon_node + loss_rep
    ...
    def train(self):
        ...
        for epoch_counter in range(self.config['epochs']):
            for bn, data in enumerate(train_loader):
                ...
                total_loss, loss_end, loss_recon_node, loss_recon_edge, acc= self._step(model_list, data, n_iter)
                ...
                update_moving_average(self.target_ema_updater, model_recon, model)
            ...
            for bn, data in enumerate(valid_loader):
                ...
                if args.mask_edge:
                    total_loss, loss,(loss_recon_node, loss_recon_edge),  pred_node, mask_node_label0, pred_edge,mask_edge_label  \
                        = self._step_test(model_list, data, bn)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--moving_average_decay', type=float, default=0.99, help = "Decay rate for the moving average")
