...
from dataset.dataset_test_rich2_fragment import MolTestDatasetWrapperRich
from dataset.get_config import get_config 
import argparse
from torch_geometric.utils import  scatter, softmax

from torch_geometric.data import Data
from util import calc_acc, random_node
...
class FineTune(object):
    ...
    def _step(self, model_list, data, n_iter):
        ...
        selected_fragment_indices = data.motif_batch[masked_atom_indices].unique()

        all_node_indices = (data.motif_batch == selected_fragment_indices[:, None]).nonzero(as_tuple=True)[1]

        masked_atom_indices = torch.tensor(all_node_indices)
