...
class MolTestDatasetWrapperRich(object):
    ...
    def get_train_validation_data_loaders(self, train_dataset):
        ...
        train_loader = DataLoader(
            ...
            num_workers=self.num_workers, drop_last=False, collate_fn=collate_frag
        )
...
#   curr_indicator = 0
    ...
    # N을 추가한 이유는 frag_indices가 여러개 있어서
    # 하나 끝난 이후에 curr_num을 구해주기 위해
