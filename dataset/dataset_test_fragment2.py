...
class MolTestDatasetWrapper(object):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = MolTestDatasetFrag(data_path=self.data_path, target=self.target, task=self.task, mask_rate = self.mask_rate)
...
#   curr_indicator = 0
    ...
    # Identify nodes with 0 fragment indicator and assign new indices
    # 이게 생각보다 중요한거 같음 0노드가 있으면 새로운 인덱스를 할당해줘야함
