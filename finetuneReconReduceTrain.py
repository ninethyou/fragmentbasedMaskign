...
class FineTune(object):
    def __init__(self, dataset, config):
        ...
        dir_name =  savefilename + config['task_name'] + '_' + str(args.num_layer) + '_' \
                ...
                + str(args.splitting) + '_' + str(args.deviceName) + '_' + str(args.seed) + '_' + str(current_time) + '_' + str(args.reduceTrain)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--reduceTrain', type = float , default = 1, help = "Reduce the training data")
    ...
    columns = ['Time', 'Seed','result', 'reduceTrain']
    
    results_list.append([current_time, seed,  result, args.reduceTrain])
