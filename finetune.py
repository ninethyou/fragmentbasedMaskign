...
def main():
    ...
    for epoch in range(1, args.epochs+1):
        ...
        wandb.log({'loss/train': train_loss, 'accuracy/train' : train_acc})
        wandb.log({'loss/validation': val_loss, 'accuracy/validation' : val_acc})
    ...
    wandb.log({'loss/test': test_loss, 'result/test' : test_acc})
    ...
    fn_base = f'results10/{args.dataset}_downstream'
