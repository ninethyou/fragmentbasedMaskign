...
def main():
    ...
    output_file_temp = "./pretrain/" + f"{args.dataset}_{args.gnn_type}_{args.mask_rate}_{args.seed}"        
    ...
    directory_name = 'results10'
    os.makedirs(directory_name, exist_ok=True)
    df = pd.DataFrame(results_list, columns=columns)


    fn_base = f'{directory_name}/pretrain_{args.dataset}_{args.split}'
